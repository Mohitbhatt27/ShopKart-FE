...
import Designer from "../assets/SK.png";
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-2 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center ">
                  <img
                    className=" h-12 w-auto hidden md:flex"
                    src={Designer}
                    alt="Your Company"
                  />
                </div>
              ...
              <label className="hidden lg:input lg:input-bordered lg:flex lg:items-center gap-2 w-[45%]">
